...
const Certification = () => {
	...
	if (isLoading) {
		return (
			<section id="certificate" className="bg-[#0b0a27] text-white">
				<h1 className="pl-[20px] xl:pl-[100px] text-[16px] sm:text-[20px] xl:text-[26px] 2xl:text-[36px] italic uppercase font-bold py-5 mt-0">certificates</h1>
				<hr></hr>
				<div>
	...
	return (
		<section id="certificate" className="bg-[#0b0a27] text-white">
			<h1 className="pl-[20px] xl:pl-[100px] text-[16px] sm:text-[20px] xl:text-[26px] 2xl:text-[36px] italic uppercase font-bold py-5 mt-0">サーティフィケート</h1>
			<hr></hr>
						...
						<div className="text-[#FFFFFF] flex justify-between" key={certification.id}>
							<div className="flex min-w-[280px] xl:min-w-[900px] my-10">
								...
								<div className="ml-2 w-[200px] sm:w-[500px] xl:w-[800px] 2xl:w-[900px]">
									...
									<p className="hidden xl:block font-Code-Pro text-xs xl:text-sm 2xl:text-base mb-5 w-[580px] 2xl:w-[880px]">{certification.description_jp}</p>
								</div>
							</div>
							<div className="mx-4 xl:mx-20 flex items-center">
