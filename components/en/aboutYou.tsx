			...
			<div className="relative z-10 bg-gradient-to-t  from-[#0B0A27] from-50% text-white mb-0 pt-12">
				...
				<div className="ml-[20px] xl:ml-[100px] mr-[20px] xl:mr-0">
					<p className="font-Code-Pro w-30 xl:w-[670px] 2xl:w-[980px] text-sm xl:text-base 2xl:text-lg">
						Hello Everyone, My Name is Zulfikhar. I am a third-year undergraduate student majoring in Electrical Engineering at Telkom University in Bandung, Indonesia. My interests are in software and hardware development,
						particularly in areas such as Web Applications, Artificial Intelligence, among others. Currently, my goal is to conduct research in the field of Artificial Intelligence, specifically focusing on image processing.
					</p>
